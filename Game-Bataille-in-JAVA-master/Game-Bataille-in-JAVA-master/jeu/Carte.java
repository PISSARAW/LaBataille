...
public class Carte{
	...
	*/
	...
	/**
	 * Cr�er une carte nulle (permet d'�viter et de controler l'ajout de carte du Plateau vers la Main lorsque le joueur n'a plus de carte)
	 */
	public Carte(){
		this.hauteur=0;
		this.couleur=0;
	...
	/**
	 * M�thode permet de r�cup�rer le symbole d'une carte
	...
	*/
	...
	/**
	 * M�thode permettant de controler si la couleur de la carte est valide
	* @param c couleur de la carte
	...
	* @return true les cartes ont la m�me hauteur
	*/
	 ...
	 * @return -1 la carte compar� est sup�rieur 0 les cartes ont m�me puissance
	 */
