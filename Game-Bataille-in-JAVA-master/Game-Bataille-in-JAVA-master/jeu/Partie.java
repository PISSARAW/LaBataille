...
public class Partie extends Observable {
	...
	/**
	 * M�thode permettant d'initialiser une partie de jeu normale
	 *
	 * @return p retourne la partie cr�ee
	 */
	...
	public static Partie initialiseLeJeu(int nbJoueur, int tailleJeuCarte, int nbJeuCarte, ArrayList<String> nomsDesJoueurs) {
		Partie p = new Partie(nbJoueur, tailleJeuCarte, nbJeuCarte);
		JeudeCartes jeuCartes = new JeudeCartes();
		jeuCartes.creationPaquet(tailleJeuCarte, nbJeuCarte);

		for (int i=0; i<nbJoueur;i++){
			Joueur joueur=new Joueur(nomsDesJoueurs.get(i),i); // !!! ajouter une main au joueur au constructeur de joueur !!!
			jeuCartes.distribuerCarte(joueur,p);
			p.getListeJoueur().add(joueur);
		}/*
		int i = 0;
		for (String j : nomsDesJoueurs) {
			Joueur joueur = new Joueur(j, i);
			jeuCartes.distribuerCarte(joueur, p);
			p.getListeJoueur().add(joueur);
			i++;
	...
	public  static Partie intialiseTest1() throws Exception{
	...
	/**
	 *M�thode permettant d'initialiser le jeu essai 2
	 * @return p partie cr�ee
	 * @throws Exception
	 */
	...
	/**
	 * M�thode permettant d'initialiser le jeu essai 3
	 * @return p partie cr�ee
	 * @throws Exception
	 */
